...
Route.group(()=>{
  ...
  Route.post('/api/solicitations/:solicitation_id/send/:unit_id', 'SolicitationController.send') //Send solicitation
})
...
Route.group(()=>{
  ...
  Route.post('/api/documents/:id/attachments', 'AttachmentController.store') //Add attachment to document
})
